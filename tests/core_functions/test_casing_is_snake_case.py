...
def test_is_snake_case_with_disallow_digits_true_and_separator_char(
    input, expected_result
):
    assert (
        is_snake_case(
...
def test_is_snake_case_with_disallow_digits_false_and_separator_char(
    input, expected_result
):
    assert (
        is_snake_case(
...
def test_is_snake_case_with_disallow_digits_true_and_separator_char_and_separator_allow_leading_true(
    input, expected_result
):
    assert (
        is_snake_case(
...
def test_is_snake_case_with_disallow_digits_false_and_separator_char_and_separator_allow_leading_true(
    input, expected_result
):
    assert (
        is_snake_case(
